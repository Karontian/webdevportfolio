...
import pfp from "../photoAvatar.png";
import {
  Bars3Icon,
  XMarkIcon,
  SunIcon,
      ...
      <header className="fixed bg-base-300 shadow-2xl shadow-neutral inset-x-0 top-0 z-50">
        ...
        >
          <div className="flex lg:flex-1">
            <p className="-m-1.5 p-1.5 font-semibold">Welcome!</p>
          </div>
          ...
          >
            ...
            <div className="grid justify-center items-center mt-3">
              ...
              <div className="text-center">
                ...
                <a href="https://www.linkedin.com/in/pablo-calvo-77314a246" target="_blank" rel="noopener noreferrer" className="btn btn-outline btn-square">
                  <svg
                ...
                <a href="https://github.com/Karontian" target="_blank" rel="noopener noreferrer" className="btn btn-outline btn-square">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-8 w-8"
                    fill="currentColor"
